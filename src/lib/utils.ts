 ...
 */
const CHROME_STORE_PATTERN = /^https:\/\/chromewebstore\.google\.com\/detail\/[^/]+\/([a-z]{32})/;
 ...
 * @returns CRX 文件下载直链
 */
export function generateDownloadUrl(extensionId: string, chromeVersion = '130.0.0.0'): string {
